	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home_manager.php">AIT<span class="display"></span></a></h1>
   ...
   while($row1 = mysqli_fetch_assoc($result1)){
     ...
     if($result3){
     	...
     	if($result4){
     		...
     		echo "<script type='text/javascript'>alert('Failed to allocate Rooms1')</script>";
     	}
     }
     else{
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand"  href="http://www.acharya.ac.in/" target="_blank" >AIT<span class="display"> BANGALORE</span></a>
		</div>
